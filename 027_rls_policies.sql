...
--                maintenance_schedules, inspections, workshops;
--                no DELETE
--  Technician → SELECT all; INSERT/UPDATE maintenance_schedules
...
BEGIN
  FOR tbl, pol IN
    ...
    WHERE schemaname = 'public'
      AND tablename IN (
        'rigs','contracts','assets','bom_items','maintenance_schedules',
